...
typedef struct {
	...
	int prompt_len;                    // visible prompt length (for cursor math)
...
// Override the prompt string and its visible length.
void microrl_set_prompt (microrl_t * pThis, char * prompt_str, int prompt_len);
